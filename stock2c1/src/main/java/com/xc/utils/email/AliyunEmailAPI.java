...
public class AliyunEmailAPI {
    ...
    private final static String AccessKeyId = "121212";
    private final static String AccessKeySecret = "12121212";
    //发信地址
    private final static String AccountName = "12121@service.coinlabc.com";
